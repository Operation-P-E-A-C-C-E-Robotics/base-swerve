...
public class RobotContainer {
    ...
    EnumSendableChooser<DiverterStatemachine.DiverterState> diverterStateChooser = new EnumSendableChooser<>(DiverterStatemachine.DiverterState.values());
